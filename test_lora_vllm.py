...
LORA_ADAPTER_PATH = r"/storage/public/liutg/qyguo/qyguo_llm/LoRA/output/lora_3/final_model"
LORA_ADAPTER_NAME = "lora_adapter" # 给LoRA一个名字
...
def save_classified_samples(output_dir_base, test_set_name, test_data, ground_truths, predictions):
    ...
    for i in range(len(test_data)):
        ...
        # Positive=1 (AI), Negative=0 (Human)
